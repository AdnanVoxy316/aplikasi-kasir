...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username_value === '' || $password === '') {
        ...
        $query = "SELECT id, username, nama_lengkap, role, password, cashier_id, contact_number, email, profile_photo FROM users WHERE username = '$safe_username' AND role = 'kasir' AND is_active = 1 LIMIT 1";
